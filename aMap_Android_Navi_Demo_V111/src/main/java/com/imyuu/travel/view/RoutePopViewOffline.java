 ...
 * 
 */
public class RoutePopViewOffline extends PopupWindow {

	private String scenicId;
	private MapOfflineActivity context;
	 ...
	 */
	public RoutePopViewOffline(MapOfflineActivity context, String scenicId, View view) {
	...
	public void setOnClickListener(final LinearLayout in) {
		...
		in.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (RoutePopViewOffline.this.isShowing()) RoutePopViewOffline.this.dismiss();
