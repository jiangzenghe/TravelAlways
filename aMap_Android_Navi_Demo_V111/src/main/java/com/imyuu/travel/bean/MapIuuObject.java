...
public class MapIuuObject extends MapObject {

	public MapIuuObject(Object id, Drawable drawable, int x, int y,
	...
	public MapIuuObject(Object id, Drawable drawable, int x, int y, int pivotX,
			int pivotY, boolean isTouchable, boolean isScalable) {
	...
	public MapIuuObject(Object id, Drawable drawable, Point position,
			boolean isTouchable, boolean isScalable) {
